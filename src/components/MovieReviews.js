...
export default function MovieReviews(props){
	return <div style={{display: "flex", flexWrap: "wrap"}}>
		...
		{props.reviews.map(review =>
			<a href={review.link.url} key={review.display_title} style={{
					color: "black",
					textDecoration: "none"
				}}>
				<div style={{
						width: review.multimedia.width * 2,
						height: review.multimedia.height * 4,
						margin: "1.25em",
					...
					<div style={{padding: "0 1.15em 1.15em"}}>
						...
						<div style={{display: "flex", width: "100%", justifyContent: "space-between"}}>
							...
							{
								["R", "G", "PG", "PG-13"].includes(review.mpaa_rating)
									? <img alt={`Rated ${review.mpaa_rating}`}  width="75px" style={{transform: "rotate(10deg)", marginTop: "-2em"}}
											src={
